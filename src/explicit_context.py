...
research_task = Task(
    description=("Research the current state of electric vehicle adoption worldwide"),
    expected_output=("A bullet-point list of key statistics and trends in EV adoption"),
    agent=researcher,
)
